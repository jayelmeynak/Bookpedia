...
import com.plcoding.bookpedia.presentation.book_detail.components.BlurredImageBackground
import com.plcoding.bookpedia.presentation.book_detail.components.BookChip
import com.plcoding.bookpedia.presentation.book_detail.components.ChipSize
import com.plcoding.bookpedia.presentation.book_detail.components.TitledContent
...
fun BookDetailScreenRoot(
    ...
    BookDetailScreen(
        ...
        onAction = { bookDetailAction ->
            ...
            viewModel.onAction(bookDetailAction)
        }
    )
}
                    ...
                    Row(
                        ...
                        state.book.numPages?.let { pageCount ->
                            TitledContent(title = stringResource(Res.string.pages)) {
                                BookChip { Text(text = pageCount.toString()) }
                            }
                        }
                    }
